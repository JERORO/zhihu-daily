...
class Request {
    ...
    func POST(originalurl : String,originaldata : String,completion : @escaping (Any,Bool) -> Void)
    {
        //对请求路径的说明
        //协议头+主机地址+接口名称
    ...
    //发送POST请求NSURLSession
    func GET(originalurl : String,originaldata : String,completion : @escaping (Any,Bool) -> Void)
    {
        //对请求路径的说明
        //协议头+主机地址+接口名称
        //POST请求需要修改请求方法为POST，并把参数转换为二进制数据设置为请求体
